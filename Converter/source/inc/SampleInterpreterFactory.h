...
protected:
   ...
   std::map< const GnssMetadata::Stream::SampleFormat, fmtFuncPtr_t > mFormatFunctionMap;

public:
   SampleInterpreterFactory();
	~SampleInterpreterFactory();

   static uint32_t BitWidth( const GnssMetadata::Stream::SampleFormat& fmt, const size_t& qnt );
