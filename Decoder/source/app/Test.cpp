...
void testSuite()
{
	...
	try
	{
		...
		//alignment: Tests quantization and aligned bits.
		{
			...
			Decoder test("/Volumes/Data/BigData/SDR_Meta/Fraunhofer/L125_III1b_15s.usbx",50L,1000L,1000000L,100);
			//Decoder test("C:\\home\\data\\SDR_Meta\\Fraunhofer\\L125_III1b_15s.usbx",50L,1000L,1000000L,100);
